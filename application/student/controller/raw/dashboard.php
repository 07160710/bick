					...
					<div class="text-box">
						...
						<p class="text-muted">
							<span class="text-muted color-bottom-txt"><i class="fa fa-edit"></i>
								...
								Lorem ipsum dolor sit amet, consectetur adipiscing elit gthn. </span>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-12 col-xs-12">
				<div class="panel back-dash">
					...
					<p class="text-muted">Lorem ipsum dolor sit amet, consectetur
						adipiscing sit ametsit amet elit ftr. Lorem ipsum dolor sit amet,
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-12 col-xs-12">
				<div class="panel panel-primary text-center no-boder bg-color-green">
					...
					<div class="panel-footer back-footer-green">Disk Space Available</div>
				</div>
						...
						<ul class="chat-box">
							<li class="left clearfix"><span class="chat-img pull-left"> <img
								...
								<div class="chat-body">
									<strong>Jack Sparrow</strong> <small
										class="pull-right text-muted"> <i class="fa fa-clock-o fa-fw"></i>12
										mins ago
									</small>
							...
							<li class="left clearfix"><span class="chat-img pull-left"> <img
								...
								<div class="chat-body clearfix">
									...
									<strong>Jack Sparrow</strong> <small
										class="pull-right text-muted"> <i class="fa fa-clock-o fa-fw"></i>14
										mins ago
									</small>
