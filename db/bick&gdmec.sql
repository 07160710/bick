...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-05-19 06:11:41
-- 服务器版本： 5.7.14
-- PHP Version: 5.6.25
...
(30, 'hzj', '1fa2e4bfad6aa1be1e80d1e407fc6414'),
(31, 'hhr', '96e79218965eb72c92a549dd5a330112');
...
INSERT INTO `bk_demo` (`id`, `idno`, `name`, `height`) VALUES
(1, '123456789012345678', '张三丰', 180);
...
--
ALTER TABLE `bk_admin`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT COMMENT '管理员id', AUTO_INCREMENT=32;
--
...
--
ALTER TABLE `bk_cate`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT COMMENT '栏目id', AUTO_INCREMENT=36;
--
...
CREATE TABLE `answer_paper` (
  ...
  `paper_id` int(11) NOT NULL COMMENT '试卷号',
  `select_question_id` int(11) DEFAULT NULL COMMENT '题号',
  `select_item_id` int(11) NOT NULL COMMENT '答案号',
  `select_status` tinyint(1) NOT NULL COMMENT '选择状态',
...
INSERT INTO `answer_paper` (`id`, `studentid`, `paper_id`, `select_question_id`, `select_item_id`, `select_status`, `memo`) VALUES
(5, 7160801, 222, 0, 1, 0, NULL);
...
(1, '07160605', '2016-2017-1', 'php', 60),
(2, '07160606', '2016-2017-1', 'java', 89),
(4, '07160601', '2016-2017-1', 'java', 79);
...
CREATE TABLE `select_item` (
  ...
  `select_question_id` int(10) NOT NULL COMMENT '选择题号',
...
(14, 4, 1, 'define', NULL),
(15, 4, 0, 'defined', NULL),
(16, 4, 0, 'var_dump', NULL),
(17, 5, 0, '东奔西走基本原则地', NULL),
(18, 5, 0, '基本原则地百慕大革', NULL),
(19, 5, 0, '玷辱h', NULL),
(20, 5, 1, '地地', NULL),
(21, 6, 0, '东奔西走基本原则地', NULL),
(22, 6, 0, '基本原则地百慕大革', NULL),
(23, 6, 0, '玷辱h', NULL),
(24, 6, 1, '地地', NULL),
(25, 7, 0, 'sad', ''),
(26, 7, 1, '大厦大厦大厦磊', ''),
...
(4, 'php', '单', '在php中，定义一个常量，使用什么函数？', NULL),
(5, 'php', '单', '基本原则地asd', NULL),
(6, 'php', '单', '基本原则地asd', NULL),
(7, 'java', '多', '土塔顶地基本原则地 ', NULL);
...
ALTER TABLE `select_item`
  ADD PRIMARY KEY (`id`),
  ADD KEY `题号` (`select_question_id`) USING BTREE;
...
--
ALTER TABLE `select_item`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=29;
--
